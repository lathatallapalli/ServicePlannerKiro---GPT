...
import { ServicePlannerComponent } from './features/service-planner/service-planner.component';
...
export const routes: Routes = [
  ...
  { path: 'orders/:orderId/service-planner', component: ServicePlannerComponent },
  { path: 'service-planner', component: ServicePlannerComponent },
