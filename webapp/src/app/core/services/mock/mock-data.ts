    ...
    jobs: [
      {
        ...
        requiredResourceType: 'mechanic',
        requiredQualifications: [QUALIFICATIONS.mechanic, QUALIFICATIONS.generalService],
        resourceRequirements: [
          { resourceType: 'mechanic', requiredQualifications: [QUALIFICATIONS.mechanic, QUALIFICATIONS.generalService], label: 'Technician' },
      ...
      },
      {
        ...
        estimatedDurationMinutes: 30,
        requiredResourceType: 'mechanic',
        requiredQualifications: [QUALIFICATIONS.mechanic, QUALIFICATIONS.brakes],
        resourceRequirements: [
          { resourceType: 'mechanic', requiredQualifications: [QUALIFICATIONS.mechanic, QUALIFICATIONS.brakes], label: 'Technician' },
          { resourceType: 'bay', requiredQualifications: [QUALIFICATIONS.pcBay], label: 'PC Bay' },
        ],
        status: 'unscheduled',
      },
    ...
    jobs: [
      {
        ...
        requiredQualifications: [QUALIFICATIONS.mechanic, QUALIFICATIONS.generalService],
        resourceRequirements: [
          { resourceType: 'mechanic', requiredQualifications: [QUALIFICATIONS.mechanic, QUALIFICATIONS.generalService], label: 'Mechanic' },
          { resourceType: 'bay', requiredQualifications: [QUALIFICATIONS.pcBay], label: 'PC Bay' },
        ],
        status: 'unscheduled',
      },
      {
        ...
        requiredQualifications: [QUALIFICATIONS.mechanic, QUALIFICATIONS.brakes],
        resourceRequirements: [
          { resourceType: 'mechanic', requiredQualifications: [QUALIFICATIONS.mechanic, QUALIFICATIONS.brakes], label: 'Mechanic' },
        ],
        status: 'unscheduled',
      },
    ],
  ...
  },
  {
    ...
    jobs: [
      ...
      },
      {
        ...
        estimatedDurationMinutes: 30,
        requiredResourceType: 'mechanic',
        requiredQualifications: [QUALIFICATIONS.mechanic, QUALIFICATIONS.diagnostics],
        resourceRequirements: [
          { resourceType: 'mechanic', requiredQualifications: [QUALIFICATIONS.mechanic, QUALIFICATIONS.diagnostics], label: 'Mechanic' },
          { resourceType: 'device', requiredQualifications: [QUALIFICATIONS.dieselTester], label: 'Diesel tester' },
        ],
        status: 'unscheduled',
      },
