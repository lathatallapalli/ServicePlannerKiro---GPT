...
export const MOCK_RESOURCES: Resource[] = [
  ...
  { id: 'vie-tech-brenda-miller', name: 'Brenda Miller', type: 'mechanic', groupId: 'group-vienna-technicians', qualifications: [QUALIFICATIONS.mechanic], displayTags: ['Mechanic'], demoLocationId: 'vienna' },
  { id: 'vie-tech-mark-peterson', name: 'Mark Peterson', type: 'mechanic', groupId: 'group-vienna-technicians', qualifications: [QUALIFICATIONS.mechanic], displayTags: ['Mechanic'], demoLocationId: 'vienna' },
  { id: 'vie-tech-lisa-smith', name: 'Lisa Smith', type: 'mechanic', groupId: 'group-vienna-technicians', qualifications: [QUALIFICATIONS.mechanic, QUALIFICATIONS.electrician], displayTags: ['Mechanic', 'Electrician'], demoLocationId: 'vienna' },
  { id: 'vie-tech-samuel-frazor', name: 'Samuel Frazor', type: 'mechanic', groupId: 'group-vienna-technicians', qualifications: [QUALIFICATIONS.mechanic], displayTags: ['Mechanic'], demoLocationId: 'vienna' },
