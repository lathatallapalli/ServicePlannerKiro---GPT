...
export const MOCK_GROUPS: ResourceGroup[] = [
  ...
  { id: 'group-vienna-technicians', name: 'Technicians A', resourceType: 'mechanic' },
  { id: 'group-vienna-technicians-b', name: 'Technicians B', resourceType: 'mechanic' },
...
export const MOCK_RESOURCES: Resource[] = [
  ...
  { id: 'bay-pc-1', name: 'PC Bay 1', type: 'bay', groupId: 'group-bays', qualifications: [QUALIFICATIONS.pcBay] },
  { id: 'bay-pc-2', name: 'PC Bay 2', type: 'bay', groupId: 'group-bays', qualifications: [QUALIFICATIONS.pcBay] },
  { id: 'bay-pc-3', name: 'PC Bay 3', type: 'bay', groupId: 'group-bays', qualifications: [QUALIFICATIONS.pcBay] },
  { id: 'bay-lt-1', name: 'LT Bay 1', type: 'bay', groupId: 'group-bays', qualifications: [QUALIFICATIONS.ltBay] },
  { id: 'bay-scenario-express', name: 'LT Bay 2', type: 'bay', groupId: 'group-bays', qualifications: [QUALIFICATIONS.ltBay] },
  { id: 'bay-pc-alignment', name: 'PC Alignment', type: 'bay', groupId: 'group-bays', qualifications: [QUALIFICATIONS.pcAlignmentBay] },
  ...
  { id: 'vie-tech-mark-owen', name: 'Mark Owen', type: 'mechanic', groupId: 'group-vienna-technicians', qualifications: [QUALIFICATIONS.mechanic], displayTags: ['Mechanic'], demoLocationId: 'vienna' },
  { id: 'vie-tech-phil-parker', name: 'Phil Parker', type: 'mechanic', groupId: 'group-vienna-technicians', qualifications: [QUALIFICATIONS.mechanic], displayTags: ['Mechanic'], demoLocationId: 'vienna' },
  { id: 'vie-tech-greg-jackson', name: 'Greg Jackson', type: 'mechanic', groupId: 'group-vienna-technicians', qualifications: [QUALIFICATIONS.mechanic], displayTags: ['Mechanic'], demoLocationId: 'vienna' },
  { id: 'vie-tech-jeff-goldberg', name: 'Jeff Goldberg', type: 'mechanic', groupId: 'group-vienna-technicians', qualifications: [QUALIFICATIONS.mechanic], displayTags: ['Mechanic'], demoLocationId: 'vienna' },
  { id: 'vie-tech-kelly-hanson', name: 'Kelly Hanson', type: 'mechanic', groupId: 'group-vienna-technicians', qualifications: [QUALIFICATIONS.mechanic, QUALIFICATIONS.electrician], displayTags: ['Mechanic', 'Electrician'], demoLocationId: 'vienna' },
  { id: 'vie-tech-brenda-miller', name: 'Brenda Miller', type: 'mechanic', groupId: 'group-vienna-technicians-b', qualifications: [QUALIFICATIONS.mechanic], displayTags: ['Mechanic'], demoLocationId: 'vienna' },
  { id: 'vie-tech-mark-peterson', name: 'Mark Peterson', type: 'mechanic', groupId: 'group-vienna-technicians-b', qualifications: [QUALIFICATIONS.mechanic], displayTags: ['Mechanic'], demoLocationId: 'vienna' },
  { id: 'vie-tech-lisa-smith', name: 'Lisa Smith', type: 'mechanic', groupId: 'group-vienna-technicians-b', qualifications: [QUALIFICATIONS.mechanic, QUALIFICATIONS.electrician], displayTags: ['Mechanic', 'Electrician'], demoLocationId: 'vienna' },
  { id: 'vie-tech-samuel-frazor', name: 'Samuel Frazor', type: 'mechanic', groupId: 'group-vienna-technicians-b', qualifications: [QUALIFICATIONS.mechanic], displayTags: ['Mechanic'], demoLocationId: 'vienna' },
  ...
  { id: 'vie-advisor-frank-reynold', name: 'Frank Reynold', type: 'advisor', groupId: 'group-vienna-advisors', qualifications: [], displayTags: ['Advisor'], demoLocationId: 'vienna' },
  { id: 'vie-advisor-tom-hunter', name: 'Tom Hunter', type: 'advisor', groupId: 'group-vienna-advisors', qualifications: [], displayTags: ['Advisor'], demoLocationId: 'vienna' },
  { id: 'vie-advisor-phil-wilson', name: 'Phil Wilson', type: 'advisor', groupId: 'group-vienna-advisors', qualifications: [], displayTags: ['Advisor'], demoLocationId: 'vienna' },
  { id: 'vie-advisor-brandon-richards', name: 'Brandon Richards', type: 'advisor', groupId: 'group-vienna-advisors', qualifications: [], displayTags: ['Advisor'], demoLocationId: 'vienna' },
...
const mayPlannerDemoBookings: Array<{
  ...
  { day: 1, reference: '014826501', jobId: 'job-may-d01-1', resourceId: 'mech-mark-owen', start: '09:15', end: '11:15', title: 'May service inspection' },
  { day: 1, reference: '014826501', jobId: 'job-may-d01-2', resourceId: 'advisor-ted-phillips', start: '09:00', end: '10:30', title: 'Customer intake', category: 'activity' },
  { day: 2, reference: '014826502', jobId: 'job-may-d02-1', resourceId: 'mech-phil-parker', start: '10:00', end: '14:30', title: 'Brake noise diagnosis' },
  { day: 2, reference: '014826502', jobId: 'job-may-d02-2', resourceId: 'car-audi-a4-kl657og', start: '09:00', end: '17:30', title: 'Courtesy car reservation', category: 'activity' },
  { day: 5, reference: '014826503', jobId: 'job-may-d05-1', resourceId: 'mech-greg-jackson', start: '09:00', end: '16:30', title: 'MOT preparation' },
  { day: 5, reference: '014826503', jobId: 'job-may-d05-2', resourceId: 'advisor-frank-miller', start: '14:00', end: '16:00', title: 'Repair approval calls', category: 'activity' },
  { day: 6, reference: '014826504', jobId: 'job-may-d06-1', resourceId: 'mech-jeff-goldberg', start: '09:30', end: '12:30', title: 'Suspension repair' },
  { day: 6, reference: '014826504', jobId: 'job-may-d06-2', resourceId: 'car-audi-a3-kl643ju', start: '10:00', end: '18:00', title: 'Courtesy car reservation', category: 'activity' },
  { day: 7, reference: '014826505', jobId: 'job-may-d07-1', resourceId: 'mech-kelly-hanson', start: '11:00', end: '15:00', title: 'Control unit diagnostics' },
  { day: 7, reference: '014826505', jobId: 'job-may-d07-2', resourceId: 'advisor-ted-phillips', start: '09:00', end: '13:00', title: 'Service advisor appointments', category: 'activity' },
  { day: 8, reference: '014826506', jobId: 'job-may-d08-1', resourceId: 'mech-scenario-flex', start: '09:00', end: '18:00', title: 'High-priority workshop support' },
  { day: 8, reference: '014826506', jobId: 'job-may-d08-2', resourceId: 'car-bmw-320-mw112ab', start: '09:00', end: '21:00', title: 'Courtesy car all day', category: 'activity' },
  { day: 9, reference: '014826507', jobId: 'job-may-d09-1', resourceId: 'mech-mark-owen', start: '09:30', end: '11:30', title: 'Tyre pressure warning' },
  { day: 9, reference: '014826507', jobId: 'job-may-d09-2', resourceId: 'mech-phil-parker', start: '13:00', end: '17:00', title: 'Brake pad replacement' },
  { day: 12, reference: '014826508', jobId: 'job-may-d12-1', resourceId: 'advisor-frank-miller', start: '09:00', end: '16:30', title: 'Reception coverage', category: 'activity' },
  { day: 12, reference: '014826508', jobId: 'job-may-d12-2', resourceId: 'mech-greg-jackson', start: '10:00', end: '12:30', title: 'Emissions fault diagnosis' },
  { day: 13, reference: '014826509', jobId: 'job-may-d13-1', resourceId: 'mech-jeff-goldberg', start: '09:00', end: '11:00', title: 'Steering vibration check' },
  { day: 13, reference: '014826509', jobId: 'job-may-d13-2', resourceId: 'car-scenario-courtesy', start: '09:00', end: '15:00', title: 'Short courtesy car booking', category: 'activity' },
  { day: 14, reference: '014826511', jobId: 'job-may-d14-1', resourceId: 'mech-kelly-hanson', start: '09:00', end: '12:00', title: 'Battery draw test' },
  { day: 14, reference: '014826511', jobId: 'job-may-d14-2', resourceId: 'advisor-ted-phillips', start: '13:00', end: '17:00', title: 'Customer handover block', category: 'activity' },
  { day: 15, reference: '014826512', jobId: 'job-may-d15-1', resourceId: 'mech-phil-parker', start: '09:00', end: '21:00', title: 'Major repair day' },
  { day: 15, reference: '014826512', jobId: 'job-may-d15-2', resourceId: 'car-audi-a4-kl657og', start: '09:00', end: '21:00', title: 'Courtesy car all day', category: 'activity' },
  { day: 16, reference: '014826513', jobId: 'job-may-d16-1', resourceId: 'mech-mark-owen', start: '10:00', end: '13:00', title: 'Final inspection' },
  { day: 16, reference: '014826513', jobId: 'job-may-d16-2', resourceId: 'advisor-frank-miller', start: '09:00', end: '11:00', title: 'Check-in wave', category: 'activity' },
  { day: 19, reference: '014826514', jobId: 'job-may-d19-1', resourceId: 'mech-greg-jackson', start: '09:00', end: '15:30', title: 'Diagnostics backlog' },
  { day: 19, reference: '014826514', jobId: 'job-may-d19-2', resourceId: 'mech-jeff-goldberg', start: '12:30', end: '17:30', title: 'Workshop overflow' },
  { day: 20, reference: '014826515', jobId: 'job-may-d20-1', resourceId: 'advisor-scenario-lead', start: '09:00', end: '18:00', title: 'Service advisor desk', category: 'activity' },
  { day: 20, reference: '014826515', jobId: 'job-may-d20-2', resourceId: 'car-audi-a3-kl643ju', start: '09:00', end: '17:00', title: 'Courtesy car booking', category: 'activity' },
  { day: 21, reference: '014826516', jobId: 'job-may-d21-1', resourceId: 'mech-scenario-flex', start: '09:00', end: '12:00', title: 'Express jobs support' },
  { day: 21, reference: '014826516', jobId: 'job-may-d21-2', resourceId: 'mech-kelly-hanson', start: '13:00', end: '18:00', title: 'Electrical diagnosis' },
  { day: 22, reference: '014826517', jobId: 'job-may-d22-1', resourceId: 'car-bmw-320-mw112ab', start: '09:00', end: '21:00', title: 'Courtesy car all day', category: 'activity' },
  { day: 22, reference: '014826517', jobId: 'job-may-d22-2', resourceId: 'mech-phil-parker', start: '10:00', end: '14:00', title: 'Brake repair follow-up' },
  { day: 23, reference: '014826518', jobId: 'job-may-d23-1', resourceId: 'mech-mark-owen', start: '09:30', end: '12:00', title: 'Quick service package' },
  { day: 23, reference: '014826518', jobId: 'job-may-d23-2', resourceId: 'advisor-ted-phillips', start: '10:00', end: '15:00', title: 'Advisor bookings', category: 'activity' },
  { day: 26, reference: '014826519', jobId: 'job-may-d26-1', resourceId: 'mech-jeff-goldberg', start: '09:00', end: '18:00', title: 'Workshop campaign' },
  { day: 26, reference: '014826519', jobId: 'job-may-d26-2', resourceId: 'car-scenario-courtesy', start: '12:00', end: '18:00', title: 'Afternoon courtesy car', category: 'activity' },
  { day: 27, reference: '014826520', jobId: 'job-may-d27-1', resourceId: 'mech-kelly-hanson', start: '10:00', end: '12:30', title: 'Battery replacement' },
  { day: 27, reference: '014826520', jobId: 'job-may-d27-2', resourceId: 'advisor-frank-miller', start: '09:00', end: '14:00', title: 'Advisor customer calls', category: 'activity' },
  { day: 28, reference: '014826521', jobId: 'job-may-d28-1', resourceId: 'mech-greg-jackson', start: '09:00', end: '11:30', title: 'A/C service' },
  { day: 28, reference: '014826521', jobId: 'job-may-d28-2', resourceId: 'car-audi-a4-kl657og', start: '09:00', end: '18:00', title: 'Courtesy car booking', category: 'activity' },
  { day: 29, reference: '014826522', jobId: 'job-may-d29-1', resourceId: 'mech-scenario-flex', start: '09:00', end: '15:00', title: 'Workshop recovery block' },
  { day: 29, reference: '014826522', jobId: 'job-may-d29-2', resourceId: 'advisor-scenario-lead', start: '13:00', end: '17:30', title: 'Late handovers', category: 'activity' },
  { day: 30, reference: '014826523', jobId: 'job-may-d30-1', resourceId: 'mech-mark-owen', start: '09:00', end: '10:30', title: 'Pre-weekend check' },
  { day: 30, reference: '014826523', jobId: 'job-may-d30-2', resourceId: 'car-audi-a3-kl643ju', start: '09:00', end: '13:00', title: 'Morning courtesy car', category: 'activity' },
];
...
const mayPlannerDayCapacity: Array<{
  ...
  { day: 2, reference: '014826502', jobId: 'job-may-d02-1', resourceId: 'mech-jeff-goldberg', hours: 2, title: 'Prepare parts and road test' },
  { day: 6, reference: '014826504', jobId: 'job-may-d06-2', resourceId: 'mech-greg-jackson', hours: 3, title: 'Capacity hold: diagnostics' },
  { day: 8, reference: '014826506', jobId: 'job-may-d08-1', resourceId: 'advisor-frank-miller', hours: 2, title: 'Callback capacity' },
  { day: 12, reference: '014826508', jobId: 'job-may-d12-2', resourceId: 'mech-phil-parker', hours: 4, title: 'Capacity hold: brake repair' },
  { day: 15, reference: '014826512', jobId: 'job-may-d15-2', resourceId: 'advisor-ted-phillips', hours: 3, title: 'Capacity hold: handovers' },
  { day: 19, reference: '014826514', jobId: 'job-may-d19-1', resourceId: 'car-scenario-courtesy', hours: 6, title: 'Courtesy car day hold' },
  { day: 22, reference: '014826517', jobId: 'job-may-d22-2', resourceId: 'mech-mark-owen', hours: 2, title: 'Capacity hold: quality check' },
  { day: 28, reference: '014826521', jobId: 'job-may-d28-1', resourceId: 'mech-kelly-hanson', hours: 3, title: 'Capacity hold: A/C follow-up' },
];
...
export const MOCK_WORK_ORDERS: WorkOrder[] = [
  ...
  },
  {
    ...
    customer: {
      ...
      country: 'Austria',
      phone: '+43 1 455000',
      email: 'service@beta-vienna.example',
    },
    jobs: [
      {
      ...
      {
        id: 'wo-014826455:act-mobility',
        workOrderId: 'wo-014826455',
        title: 'Mobility Service',
        fru: 1,
        estimatedDurationMinutes: 60,
        requiredResourceType: 'driver',
        requiredQualifications: [],
        resourceRequirements: [{ resourceType: 'driver', requiredQualifications: [], label: 'Courtesy Car' }],
        resourceLabel: 'Courtesy Car',
        status: 'unscheduled',
        workorderItemStatus: 'unscheduled',
        workorderItemCategory: 'activity',
        templateId: 'act-mobility',
      },
    ],
    createdAt: baseDate,
    updatedAt: baseDate,
    notes: 'Vienna request-stage order; customer requested drop-off near 08:30 and return near 17:00, but no booking is pre-planned.',
  },
  {
    id: 'wo-014826610',
  ...
  },
  {
    ...
    jobs: [
      ...
      },
      {
        ...
        workOrderId: 'wo-014826615',
        title: 'Tyre Repair',
        description: 'Inspect, repair, and restore damaged tyres to ensure safe vehicle operation and optimal performance.',
        fru: 0.5,
        estimatedDurationMinutes: 30,
        requiredResourceType: 'mechanic',
        requiredQualifications: [QUALIFICATIONS.tyres],
  ...
  },
  {
    ...
    jobs: [
      {
        id: 'job-014826616-front-brake-replacement',
        workOrderId: 'wo-014826616',
        title: 'Front Brake Replacement',
        description: 'Replace front brake pads and discs, inspect brake lines and fluid condition, and document safety recommendation before offer approval.',
        fru: 3,
      ...
      {
        id: 'job-014826616-tire-change',
        workOrderId: 'wo-014826616',
        title: 'Tire Change',
        description: 'Change tyres, check tyre pressures and tread condition, and record wheel safety checks.',
        fru: 0.5,
        estimatedDurationMinutes: 30,
        requiredResourceType: 'mechanic',
        requiredQualifications: [QUALIFICATIONS.tyres],
    ...
    createdAt: baseDate,
    updatedAt: baseDate,
    notes: 'Klagenfurt pending demo order for front brake replacement, tire change, and courtesy car.',
  },
  {
    id: 'wo-014826617',
  ...
  {
    id: 'wo-vie-2007',
    referenceNumber: '014826707',
    status: 'preparation',
    workflowState: 'preparation',
    demoLocationId: 'vienna',
    vehicle: {
      id: 'vehicle-014826707',
      licensePlate: 'W 707 GS',
      make: 'Audi',
      model: 'A4 Avant',
      vin: 'WAUVIE00000026707',
      mileage: 63000,
      location: 'Vienna',
    },
    customer: {
      id: 'customer-vienna-gastro-service',
      name: 'Vienna Gastro Service',
      city: 'Vienna',
      country: 'Austria',
      phone: '+43 1 826707',
      email: 'fleet@vienna-gastro.example',
    },
    jobs: [
      {
        id: 'job-vie-2007-standard-service',
        workOrderId: 'wo-vie-2007',
        title: 'Standard Service',
        description: 'Perform standard service checklist, replace oil and filter, inspect fluids and reset service indicator.',
        fru: 1,
        estimatedDurationMinutes: 60,
        requiredResourceType: 'mechanic',
        requiredQualifications: [QUALIFICATIONS.mechanic],
      ...
      {
        id: 'job-vie-2007-brake-check',
        workOrderId: 'wo-vie-2007',
        title: 'Brake Check',
        description: 'Inspect brake pads, discs and fluid condition before releasing the vehicle.',
        fru: 0.5,
        estimatedDurationMinutes: 30,
        requiredResourceType: 'mechanic',
        requiredQualifications: [QUALIFICATIONS.mechanic],
      ...
      {
        id: 'job-vie-2007-engine-repair',
        workOrderId: 'wo-vie-2007',
        title: 'Engine Repair',
        description: 'Full engine overhaul including timing chain replacement, valve adjustment and seals. Multi-day job requiring continuous bay occupation.',
        fru: 6,
    ...
    createdAt: baseDate,
    updatedAt: baseDate,
    notes: 'Vienna scheduled demo order distributed across general service and brake resources.',
  },
  {
    id: 'wo-vie-2008',
    referenceNumber: '014826708',
    status: 'preparation',
    workflowState: 'preparation',
    demoLocationId: 'vienna',
    vehicle: {
      id: 'vehicle-014826708',
      licensePlate: 'W 708 EL',
      make: 'BMW',
      model: 'i4',
      vin: 'WBAVIE00000026708',
      mileage: 37000,
      location: 'Vienna',
    },
    customer: {
      id: 'customer-danube-electric',
      name: 'Danube Electric Fleet',
      city: 'Vienna',
      country: 'Austria',
      phone: '+43 1 826708',
      email: 'service@danube-electric.example',
    },
    jobs: [
      {
        id: 'job-vie-2008-electric-diagnosis',
        workOrderId: 'wo-vie-2008',
        title: 'Electrical Diagnosis',
        description: 'Diagnose charging system warning and document electrical test results.',
        fru: 1,
        estimatedDurationMinutes: 60,
        requiredResourceType: 'mechanic',
      ...
      {
        id: 'job-vie-2008-final-scan',
        workOrderId: 'wo-vie-2008',
        title: 'Final Diagnostic Scan',
        description: 'Run final scan and attach diagnostic report after electrical checks.',
        fru: 0.5,
        estimatedDurationMinutes: 30,
        requiredResourceType: 'mechanic',
        requiredQualifications: [QUALIFICATIONS.mechanic, QUALIFICATIONS.electrician],
    ...
    createdAt: baseDate,
    updatedAt: baseDate,
    notes: 'Vienna scheduled electric diagnosis order using available electrician and diagnostic resources.',
  },
  {
    id: 'wo-vie-2009',
    referenceNumber: '014826709',
    status: 'preparation',
    workflowState: 'preparation',
    demoLocationId: 'vienna',
    vehicle: {
      id: 'vehicle-014826709',
      licensePlate: 'W 709 AL',
      make: 'Audi',
      model: 'Q5',
      vin: 'WAUVIE00000026709',
      mileage: 71000,
      location: 'Vienna',
    },
    customer: {
      id: 'customer-vienna-airport-limo',
      name: 'Vienna Airport Limo',
      city: 'Vienna',
      country: 'Austria',
      phone: '+43 1 826709',
      email: 'ops@airport-limo.example',
    },
    jobs: [
      {
        id: 'job-vie-2009-alignment',
        workOrderId: 'wo-vie-2009',
        title: 'Wheel Alignment',
        description: 'Perform wheel alignment and document before/after measurements.',
        fru: 1,
        estimatedDurationMinutes: 60,
        requiredResourceType: 'mechanic',
        requiredQualifications: [QUALIFICATIONS.mechanic],
      ...
      {
        id: 'job-vie-2009-tyre-inspection',
        workOrderId: 'wo-vie-2009',
        title: 'Tyre Inspection',
        description: 'Inspect tyres, pressures and tread condition after alignment.',
        fru: 0.5,
        estimatedDurationMinutes: 30,
        requiredResourceType: 'mechanic',
        requiredQualifications: [QUALIFICATIONS.mechanic],
    ...
    createdAt: baseDate,
    updatedAt: baseDate,
    notes: 'Vienna scheduled alignment order using the dedicated alignment bay.',
  },
  {
    id: 'wo-vie-2010',
    referenceNumber: '014826710',
    status: 'preparation',
    workflowState: 'preparation',
    demoLocationId: 'vienna',
    vehicle: {
      id: 'vehicle-014826710',
      licensePlate: 'W 710 PT',
      make: 'BMW',
      model: 'X5',
      vin: 'WBAVIE00000026710',
      mileage: 88000,
      location: 'Vienna',
    },
    customer: {
      id: 'customer-belvedere-tour',
      name: 'Belvedere Tour Fleet',
      city: 'Vienna',
      country: 'Austria',
      phone: '+43 1 826710',
      email: 'fleet@belvedere-tour.example',
    },
    jobs: [
      {
        id: 'job-vie-2010-paint-repair',
        workOrderId: 'wo-vie-2010',
        title: 'Paint Repair',
        description: 'Repair small paint damage and complete final finish inspection.',
        fru: 1,
        estimatedDurationMinutes: 60,
        requiredResourceType: 'mechanic',
        requiredQualifications: [QUALIFICATIONS.painter],
      ...
      {
        id: 'job-vie-2010-emission-validation',
        workOrderId: 'wo-vie-2010',
        title: 'Emission Validation',
        description: 'Validate emission tester result and attach final report.',
        fru: 0.5,
        estimatedDurationMinutes: 30,
        requiredResourceType: 'mechanic',
        requiredQualifications: [QUALIFICATIONS.mechanic],
    ...
    createdAt: baseDate,
    updatedAt: baseDate,
    notes: 'Vienna scheduled paint and emissions validation order using painter, LT bay and device resources.',
  },
  {
    id: 'wo-vie-2011',
    referenceNumber: '014826711',
    status: 'preparation',
    workflowState: 'preparation',
    demoLocationId: 'vienna',
    vehicle: {
      id: 'vehicle-014826711',
      licensePlate: 'W 711 CR',
      make: 'Audi',
      model: 'A5 Sportback',
      vin: 'WAUVIE00000026711',
      mileage: 59000,
      location: 'Vienna',
    },
    customer: {
      id: 'customer-city-ring-rentals',
      name: 'City Ring Rentals',
      city: 'Vienna',
      country: 'Austria',
      phone: '+43 1 826711',
      email: 'service@city-ring-rentals.example',
    },
    jobs: [
      {
        id: 'job-vie-2011-brake-service',
        workOrderId: 'wo-vie-2011',
        title: 'Brake Service',
        description: 'Replace front brake pads, inspect discs and complete brake safety check.',
        fru: 1,
        estimatedDurationMinutes: 60,
        requiredResourceType: 'mechanic',
        requiredQualifications: [QUALIFICATIONS.mechanic],
      ...
      {
        id: 'job-vie-2011-road-test',
        workOrderId: 'wo-vie-2011',
        title: 'Road Test',
        description: 'Complete road test and final service documentation.',
        fru: 0.5,
        estimatedDurationMinutes: 30,
        requiredResourceType: 'mechanic',
        requiredQualifications: [QUALIFICATIONS.mechanic],
...
export const MOCK_SCHEDULE_ENTRIES: ScheduleEntry[] = [
  ...
  { id: 'sch-vie-707-brandon-checkin', jobId: 'wo-vie-2007:act-checkin', resourceId: 'vie-advisor-brandon-richards', start: new Date('2024-04-15T12:00:00'), end: new Date('2024-04-15T12:30:00'), title: 'Check-In 014826707', color: '#A6C8FF', kind: 'blocked-order', workOrderReference: '014826707' },
  { id: 'sch-vie-707-mark-service', jobId: 'job-vie-2007-standard-service', resourceId: 'vie-tech-mark-owen', start: new Date('2024-04-15T12:30:00'), end: new Date('2024-04-15T13:30:00'), title: 'Standard Service', color: '#A6C8FF', kind: 'blocked-order', workOrderReference: '014826707' },
  { id: 'sch-vie-707-bay-service', jobId: 'job-vie-2007-standard-service', resourceId: 'vie-bay-pc-3', start: new Date('2024-04-15T12:30:00'), end: new Date('2024-04-15T13:30:00'), title: 'Standard Service', color: '#A6C8FF', kind: 'blocked-order', workOrderReference: '014826707' },
  { id: 'sch-vie-707-jeff-brake', jobId: 'job-vie-2007-brake-check', resourceId: 'vie-tech-jeff-goldberg', start: new Date('2024-04-15T13:30:00'), end: new Date('2024-04-15T14:00:00'), title: 'Brake Check', color: '#A6C8FF', kind: 'blocked-order', workOrderReference: '014826707' },
  { id: 'sch-vie-707-greg-engine-d1', jobId: 'job-vie-2007-engine-repair', resourceId: 'vie-tech-samuel-frazor', start: new Date('2024-04-15T14:00:00'), end: new Date('2024-04-15T21:00:00'), title: 'Engine Repair', color: '#A6C8FF', kind: 'blocked-order', workOrderReference: '014826707' },
  { id: 'sch-vie-707-lt-engine-d1', jobId: 'job-vie-2007-engine-repair', resourceId: 'vie-bay-lt-1', start: new Date('2024-04-15T14:00:00'), end: new Date('2024-04-15T21:00:00'), title: 'Engine Repair', color: '#A6C8FF', kind: 'blocked-order', workOrderReference: '014826707' },
  { id: 'sch-vie-707-greg-engine-d2', jobId: 'job-vie-2007-engine-repair', resourceId: 'vie-tech-samuel-frazor', start: new Date('2024-04-16T09:00:00'), end: new Date('2024-04-16T21:00:00'), title: 'Engine Repair', color: '#A6C8FF', kind: 'blocked-order', workOrderReference: '014826707' },
  { id: 'sch-vie-707-lt-engine-d2', jobId: 'job-vie-2007-engine-repair', resourceId: 'vie-bay-lt-1', start: new Date('2024-04-16T09:00:00'), end: new Date('2024-04-16T21:00:00'), title: 'Engine Repair', color: '#A6C8FF', kind: 'blocked-order', workOrderReference: '014826707' },
  { id: 'sch-vie-707-greg-engine-d3', jobId: 'job-vie-2007-engine-repair', resourceId: 'vie-tech-samuel-frazor', start: new Date('2024-04-17T09:00:00'), end: new Date('2024-04-17T21:00:00'), title: 'Engine Repair', color: '#A6C8FF', kind: 'blocked-order', workOrderReference: '014826707' },
  { id: 'sch-vie-707-lt-engine-d3', jobId: 'job-vie-2007-engine-repair', resourceId: 'vie-bay-lt-1', start: new Date('2024-04-17T09:00:00'), end: new Date('2024-04-17T21:00:00'), title: 'Engine Repair', color: '#A6C8FF', kind: 'blocked-order', workOrderReference: '014826707' },
  { id: 'sch-vie-707-phil-handover', jobId: 'wo-vie-2007:act-handover', resourceId: 'vie-advisor-phil-wilson', start: new Date('2024-04-17T21:00:00'), end: new Date('2024-04-17T21:00:00'), title: 'Handover 014826707', color: '#A6C8FF', kind: 'blocked-order', workOrderReference: '014826707' },
  { id: 'sch-vie-708-frank-checkin', jobId: 'wo-vie-2008:act-checkin', resourceId: 'vie-advisor-frank-reynold', start: new Date('2024-04-15T12:30:00'), end: new Date('2024-04-15T13:00:00'), title: 'Check-In 014826708', color: '#A6C8FF', kind: 'blocked-order', workOrderReference: '014826708' },
  { id: 'sch-vie-708-lisa-electric', jobId: 'job-vie-2008-electric-diagnosis', resourceId: 'vie-tech-lisa-smith', start: new Date('2024-04-15T13:00:00'), end: new Date('2024-04-15T14:00:00'), title: 'Electrical Diagnosis', color: '#A6C8FF', kind: 'blocked-order', workOrderReference: '014826708' },
  { id: 'sch-vie-708-bay-electric', jobId: 'job-vie-2008-electric-diagnosis', resourceId: 'vie-bay-pc-4', start: new Date('2024-04-15T13:00:00'), end: new Date('2024-04-15T14:00:00'), title: 'Electrical Diagnosis', color: '#A6C8FF', kind: 'blocked-order', workOrderReference: '014826708' },
  { id: 'sch-vie-708-kelly-scan', jobId: 'job-vie-2008-final-scan', resourceId: 'vie-tech-kelly-hanson', start: new Date('2024-04-15T14:00:00'), end: new Date('2024-04-15T14:30:00'), title: 'Final Diagnostic Scan', color: '#A6C8FF', kind: 'blocked-order', workOrderReference: '014826708' },
  { id: 'sch-vie-708-eps-scan', jobId: 'job-vie-2008-final-scan', resourceId: 'vie-device-eps-708', start: new Date('2024-04-15T14:00:00'), end: new Date('2024-04-15T14:30:00'), title: 'Final Diagnostic Scan', color: '#A6C8FF', kind: 'blocked-order', workOrderReference: '014826708' },
  { id: 'sch-vie-708-tom-handover', jobId: 'wo-vie-2008:act-handover', resourceId: 'vie-advisor-tom-hunter', start: new Date('2024-04-15T16:30:00'), end: new Date('2024-04-15T17:00:00'), title: 'Handover 014826708', color: '#A6C8FF', kind: 'blocked-order', workOrderReference: '014826708' },
  { id: 'sch-vie-709-tom-checkin', jobId: 'wo-vie-2009:act-checkin', resourceId: 'vie-advisor-tom-hunter', start: new Date('2024-04-15T13:00:00'), end: new Date('2024-04-15T13:30:00'), title: 'Check-In 014826709', color: '#A6C8FF', kind: 'blocked-order', workOrderReference: '014826709' },
  { id: 'sch-vie-709-brenda-alignment', jobId: 'job-vie-2009-alignment', resourceId: 'vie-tech-brenda-miller', start: new Date('2024-04-15T13:30:00'), end: new Date('2024-04-15T14:30:00'), title: 'Wheel Alignment', color: '#A6C8FF', kind: 'blocked-order', workOrderReference: '014826709' },
  { id: 'sch-vie-709-alignment-bay', jobId: 'job-vie-2009-alignment', resourceId: 'vie-bay-pc-alignment-1', start: new Date('2024-04-15T13:30:00'), end: new Date('2024-04-15T14:30:00'), title: 'Wheel Alignment', color: '#A6C8FF', kind: 'blocked-order', workOrderReference: '014826709' },
  { id: 'sch-vie-709-mark-tyre', jobId: 'job-vie-2009-tyre-inspection', resourceId: 'vie-tech-mark-peterson', start: new Date('2024-04-15T14:30:00'), end: new Date('2024-04-15T15:00:00'), title: 'Tyre Inspection', color: '#A6C8FF', kind: 'blocked-order', workOrderReference: '014826709' },
  { id: 'sch-vie-709-frank-handover', jobId: 'wo-vie-2009:act-handover', resourceId: 'vie-advisor-frank-reynold', start: new Date('2024-04-15T17:00:00'), end: new Date('2024-04-15T17:30:00'), title: 'Handover 014826709', color: '#A6C8FF', kind: 'blocked-order', workOrderReference: '014826709' },
  { id: 'sch-vie-710-phil-checkin', jobId: 'wo-vie-2010:act-checkin', resourceId: 'vie-advisor-phil-wilson', start: new Date('2024-04-15T13:30:00'), end: new Date('2024-04-15T14:00:00'), title: 'Check-In 014826710', color: '#A6C8FF', kind: 'blocked-order', workOrderReference: '014826710' },
  { id: 'sch-vie-710-claus-paint', jobId: 'job-vie-2010-paint-repair', resourceId: 'vie-painter-claus-ford', start: new Date('2024-04-15T14:00:00'), end: new Date('2024-04-15T15:00:00'), title: 'Paint Repair', color: '#A6C8FF', kind: 'blocked-order', workOrderReference: '014826710' },
  { id: 'sch-vie-710-lt-paint', jobId: 'job-vie-2010-paint-repair', resourceId: 'vie-bay-lt-1', start: new Date('2024-04-15T14:00:00'), end: new Date('2024-04-15T15:00:00'), title: 'Paint Repair', color: '#A6C8FF', kind: 'blocked-order', workOrderReference: '014826710' },
  { id: 'sch-vie-710-samuel-emission', jobId: 'job-vie-2010-emission-validation', resourceId: 'vie-tech-brenda-miller', start: new Date('2024-04-15T15:00:00'), end: new Date('2024-04-15T15:30:00'), title: 'Emission Validation', color: '#A6C8FF', kind: 'blocked-order', workOrderReference: '014826710' },
  { id: 'sch-vie-710-bea-emission', jobId: 'job-vie-2010-emission-validation', resourceId: 'vie-device-bea-950-1', start: new Date('2024-04-15T15:00:00'), end: new Date('2024-04-15T15:30:00'), title: 'Emission Validation', color: '#A6C8FF', kind: 'blocked-order', workOrderReference: '014826710' },
  { id: 'sch-vie-710-brandon-handover', jobId: 'wo-vie-2010:act-handover', resourceId: 'vie-advisor-brandon-richards', start: new Date('2024-04-15T17:30:00'), end: new Date('2024-04-15T18:00:00'), title: 'Handover 014826710', color: '#A6C8FF', kind: 'blocked-order', workOrderReference: '014826710' },
  { id: 'sch-vie-711-brandon-checkin', jobId: 'wo-vie-2011:act-checkin', resourceId: 'vie-advisor-brandon-richards', start: new Date('2024-04-15T14:00:00'), end: new Date('2024-04-15T14:30:00'), title: 'Check-In 014826711', color: '#A6C8FF', kind: 'blocked-order', workOrderReference: '014826711' },
  { id: 'sch-vie-711-jeff-brake', jobId: 'job-vie-2011-brake-service', resourceId: 'vie-tech-jeff-goldberg', start: new Date('2024-04-15T14:30:00'), end: new Date('2024-04-15T15:30:00'), title: 'Brake Service', color: '#A6C8FF', kind: 'blocked-order', workOrderReference: '014826711' },
  { id: 'sch-vie-711-bay-brake', jobId: 'job-vie-2011-brake-service', resourceId: 'vie-bay-pc-5', start: new Date('2024-04-15T14:30:00'), end: new Date('2024-04-15T15:30:00'), title: 'Brake Service', color: '#A6C8FF', kind: 'blocked-order', workOrderReference: '014826711' },
  { id: 'sch-vie-711-phil-roadtest', jobId: 'job-vie-2011-road-test', resourceId: 'vie-tech-phil-parker', start: new Date('2024-04-15T15:30:00'), end: new Date('2024-04-15T16:00:00'), title: 'Road Test', color: '#A6C8FF', kind: 'blocked-order', workOrderReference: '014826711' },
  { id: 'sch-vie-711-tom-handover', jobId: 'wo-vie-2011:act-handover', resourceId: 'vie-advisor-tom-hunter', start: new Date('2024-04-15T18:00:00'), end: new Date('2024-04-15T18:30:00'), title: 'Handover 014826711', color: '#A6C8FF', kind: 'blocked-order', workOrderReference: '014826711' },
  ...
  { id: 'sch-klg-613-courtesy', jobId: 'wo-014826613:act-mobility', resourceId: 'klg-car-audi-a3-k336uh', start: new Date('2024-04-15T09:30:00'), end: new Date('2024-04-15T12:30:00'), title: 'Courtesy Car 014826613', color: '#A6C8FF', kind: 'blocked-order', workOrderReference: '014826613' },
...
MOCK_WORK_ORDERS.forEach(order => {
  order.jobs.forEach(item => {
    ...
    item.status = status === 'started' ? 'in-progress' : status === 'reserved' ? 'scheduled' : status;
    item.workorderItemStatus = status === 'started' ? 'in-progress' : status;
  });
});
