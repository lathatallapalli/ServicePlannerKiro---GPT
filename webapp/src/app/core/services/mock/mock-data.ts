...
export const MOCK_RESOURCES: Resource[] = [
  ...
  { id: 'klg-mech-frank', name: 'Frank', type: 'mechanic', groupId: 'group-klagenfurt-mechanics', qualifications: [QUALIFICATIONS.generalService, QUALIFICATIONS.diagnostics, QUALIFICATIONS.tyres, QUALIFICATIONS.brakes] },
  { id: 'klg-mech-mike', name: 'Mike', type: 'mechanic', groupId: 'group-klagenfurt-mechanics', qualifications: [QUALIFICATIONS.generalService, QUALIFICATIONS.battery, QUALIFICATIONS.diagnostics] },
  { id: 'klg-mech-john', name: 'John', type: 'mechanic', groupId: 'group-klagenfurt-mechanics', qualifications: [QUALIFICATIONS.generalService, QUALIFICATIONS.mot, QUALIFICATIONS.emissions] },
  { id: 'klg-mech-peter', name: 'Peter', type: 'mechanic', groupId: 'group-klagenfurt-mechanics', qualifications: [QUALIFICATIONS.generalService, QUALIFICATIONS.brakes, QUALIFICATIONS.tyres] },
  { id: 'klg-advisor-jeff', name: 'Jeff', type: 'advisor', groupId: 'group-klagenfurt-advisors', qualifications: [] },
  { id: 'klg-advisor-tom', name: 'Tom', type: 'advisor', groupId: 'group-klagenfurt-advisors', qualifications: [] },
  { id: 'klg-car-audi-a4-k657pj', name: 'Audi A4 - K 657 PJ', type: 'driver', groupId: 'group-klagenfurt-courtesy-cars', qualifications: [] },
  { id: 'klg-car-audi-a3-k336uh', name: 'Audi A3 - K 336 UH', type: 'driver', groupId: 'group-klagenfurt-courtesy-cars', qualifications: [] },
...
export const MOCK_WORK_ORDERS: WorkOrder[] = [
  {
    ...
    customer: {
      ...
      name: 'Alpha GMBH',
      address: 'St. Martin StraÃƒÆ’Ã…Â¸e 56',
      city: 'Munich',
      country: 'Germany',
      phone: '+49 89 123456',
  ...
  },
  {
    ...
    customer: {
      ...
      name: 'WÃƒÆ’Ã‚Â¶rthersee Fleet Services',
      city: 'Klagenfurt',
      country: 'Austria',
      phone: '+43 463 826611',
  ...
  },
  {
    ...
    createdAt: baseDate,
    updatedAt: baseDate,
    notes: 'Klagenfurt demo order requiring emissions equipment plus workshop capacity.',
  },
  {
    id: 'wo-014826613',
  ...
  },
  {
    ...
    customer: {
      ...
      name: 'KÃƒÆ’Ã‚Â¤rnten Delivery Services',
      city: 'Klagenfurt',
      country: 'Austria',
      phone: '+43 463 826614',
  ...
  },
  {
    ...
    ['wo-bg-1001', '014826500', 'MÃƒÆ’Ã‚Â¼ller GmbH', 'M-BG 500', 'Oil Leak Diagnosis', 'Engine Bay Inspection', 'mech-mark-owen'],
...
export const MOCK_SCHEDULE_ENTRIES: ScheduleEntry[] = [
  ...
  { id: 'sch-klg-612-bea-mot', jobId: 'job-014826612-mot-emissions', resourceId: 'device-bea-950', start: new Date('2024-04-17T13:30:00'), end: new Date('2024-04-17T14:30:00'), title: 'MOT and Emissions Preparation', color: '#A6C8FF', kind: 'blocked-order', workOrderReference: '014826612' },
