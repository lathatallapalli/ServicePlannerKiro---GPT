...
<<<<<<< .tmp-merge-analysis/webapp__src__app__features__service-planner__service-planner.component.ts.ours
    ...
    this.clearManualInteractionState();
||||||| .tmp-merge-analysis/webapp__src__app__features__service-planner__service-planner.component.ts.base
=======
    if (!this.isWithinAppointmentBookingHours(payload.start, payload.end)) return;

>>>>>>> .tmp-merge-analysis/webapp__src__app__features__service-planner__service-planner.component.ts.theirs
